 ...
 * Generated at: 2017-05-12 12:13:59 UTC
...
public final class hello_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t<div class=\"fullscreen\"\n");
      out.write("\t\t\tstyle=\"background: rgba(0, 0, 0, .1); position: absolute; display: none;\"\n");
      out.write("\t\t\tid=\"hide_layer\">\n");
      out.write("\t\t\t<center>\n");
      out.write("\t\t\t\t<img src=\"");
      ...
      out.write("/spin.gif\" style=\"margin-top: 30%\" />\n");
      out.write("\t\t\t</center>\n");
      out.write("\t\t</div>\n");
      out.write("\t\t<div class=\"row\"\n");
      out.write("\t\t\tstyle=\"border: 1px solid rgba(0, 0, 0, 0.08); border-radius: 5px; width: 56%; margin: 0 auto; padding-bottom: 10px; max-width: 450px;\">\n");
      out.write("\t\t\t<div style=\"text-align: center;\">\n");
      out.write("\t\t\t\t<h1>AIEM</h1>\n");
      out.write("\t\t\t</div>\n");
      out.write("\t\t\t<div style=\"margin: 0px auto; color: #3C3C3C; width: 90%\">\n");
      out.write("\t\t\t\t<label style=\"font-size: 36px; font-family: monospace;\">Member\n");
      out.write("\t\t\t\t\tLogin</label> <label style=\"font-size: 16px; font-family: monospace;\">1.\n");
      out.write("\t\t\t\t\tPlease download Juiker APP, and complete the registration (limited\n");
      out.write("\t\t\t\t\tjuiker members)</label> <label\n");
      out.write("\t\t\t\t\tstyle=\"font-size: 16px; font-family: monospace;\">2. Enter\n");
      out.write("\t\t\t\t\tthe phone number and verification code login, you can open the\n");
      out.write("\t\t\t\t\tJuiker Festival fee service. (Each mobile phone door number donated\n");
      out.write("\t\t\t\t\t15 yuan, only once)</label>\n");
      out.write("\t\t\t</div>\n");
      out.write("\n");
      out.write("\t\t\t<div style=\"width: 90%; margin: 0px auto;\">\n");
      out.write("\t\t\t\t<i style=\"display: none; color: red;\" id=\"validate_null\">Field\n");
      out.write("\t\t\t\t\tis required</i> <i style=\"display: none; color: red;\"\n");
      out.write("\t\t\t\t\tid=\"validate_format\">Format error</i> <input id=mobile type=\"text\"\n");
      out.write("\t\t\t\t\tclass=\"form-control\" style=\"margin-top: 15px; width: 304px;\"\n");
      out.write("\t\t\t\t\tplaceholder=\"Please enter your phone number\" required=\"required\">\n");
      out.write("\t\t\t</div>\n");
      out.write("\t\t\t<div class=\"g-recaptcha\"\n");
      out.write("\t\t\t\tdata-sitekey=\"6LcE9hEUAAAAAPb4htczvqJRA5mLsXxl8JORAl-2\"\n");
      out.write("\t\t\t\tstyle=\"width: 90%; margin: 0px auto; margin-top: 15px\"></div>\n");
      out.write("\t\t\t<div style=\"width: 90%; margin: 0px auto; margin-top: 15px\">\n");
      out.write("\t\t\t\t<input type=\"button\" class=\"btn btn-success\" value=\"Login\"\n");
      out.write("\t\t\t\t\tonclick=\"order()\">\n");
      out.write("\t\t\t</div>\n");
      out.write("\t\t</div>\n");
      out.write("\t</div>\n");
  ...
  private boolean _jspx_meth_spring_005furl_005f0(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    // /WEB-INF/views/jsp/hello.jsp(11,0) name = value type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_spring_005furl_005f0.setValue("/resources/core/css/hello.css");
    // /WEB-INF/views/jsp/hello.jsp(11,0) name = var type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_spring_005furl_005f2(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    // /WEB-INF/views/jsp/hello.jsp(90,1) name = value type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_spring_005furl_005f2.setValue("/resources/core/js/hello.js");
    // /WEB-INF/views/jsp/hello.jsp(90,1) name = var type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
